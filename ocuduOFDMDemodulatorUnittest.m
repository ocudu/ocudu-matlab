%ocuduOFDMDemodulatorUnittest Unit tests for OFDM demodulator functions.
%   This class implements unit tests for the OFDM demodulator functions using the
%   matlab.unittest framework. The simplest use consists in creating an object with
%       testCase = ocuduOFDMDemodulatorUnittest
%   and then running all the tests with
%       testResults = testCase.run
%
%   ocuduOFDMDemodulatorUnittest Properties (Constant):
%
%   ocuduBlock      - The tested block (i.e., 'ofdm_demodulator').
%   ocuduBlockType  - The type of the tested block, including layer
%                     (i.e., 'phy/lower/modulation').
%
%   ocuduOFDMDemodulatorUnittest Properties (ClassSetupParameter):
%
%   outputPath - Path to the folder where the test results are stored.
%
%   ocuduOFDMDemodulatorUnittest Properties (TestParameter):
%
...
%
%   ocuduOFDMDemodulatorUnittest Methods (TestTags = {'testvector'}):
%
%   testvectorGenerationCases - Generates test vectors according to the provided
%                               parameters.
%
%   ocuduOFDMDemodulatorUnittest Methods (Access = protected):
%
...
classdef ocuduOFDMDemodulatorUnittest < ocuduTest.ocuduBlockUnittest
    properties (Constant)
        %Name of the tested block.
        ocuduBlock = 'ofdm_demodulator'
...
end % of classdef ocuduOFDMDemodulatorUnittest
