%ocuduPUCCHDemodulatorFormat3Unittest Unit tests for PUCCH Format 3 symbol demodulator functions.
...
%      testCase = ocuduPUCCHDemodulatorFormat3Unittest
%   and then running all the tests with
%      testResults = testCase.run
%
%   ocuduPUCCHDemodulatorFormat3Unittest Properties (Constant):
%
%   ocuduBlock      - The tested block (i.e., 'pucch_demodulator_format3').
%   ocuduBlockType  - The type of the tested block, including layer
%                     (i.e., 'phy/upper/channel_processors/pucch').
%
%   ocuduPUCCHDemodulatorFormat3Unittest Properties (ClassSetupParameter):
%
%   outputPath - Path to the folder where the test results are stored.
%
%   ocuduPUCCHDemodulatorFormat3Unittest Properties (TestParameter):
%
...
%
%   ocuduPUCCHDemodulatorFormat3Unittest Methods (TestTags = {'testvector'}):
%
%   testvectorGenerationCases - Generates a test vector according to the provided
%                               parameters.
%
%   ocuduPUCCHDemodulatorFormat3Unittest Methods (Access = protected):
%
...
classdef ocuduPUCCHDemodulatorFormat3Unittest < ocuduTest.ocuduBlockUnittest
    properties (Constant)
        %Name of the tested block.
        ocuduBlock = 'pucch_demodulator_format3'
    ...
    methods (Test, TestTags = {'testvector'})
        ...
        % DM-RS and modulation parameters.
            ...
            softBits = ocuduPUCCH3Demodulator(pucch, channelSymbols, dataChEsts, noiseVar);
...
end % of classdef ocuduPUCCHDemodulatorFormat3Unittest
