%ocuduDFTProcessorUnittest Unit tests for DFT processor functions.
...
%   object with
%       testCase = ocuduDFTProcessorUnittest
%   and then running all the tests with
%       testResults = testCase.run
%
%   ocuduDFTProcessorUnittest Properties (Constant):
%
%   ocuduBlock      - The tested block (i.e., 'dft_processor').
%   ocuduBlockType  - The type of the tested block, including layer
%                     (i.e., 'phy/generic_functions').
%
%   ocuduDFTProcessorUnittest Properties (ClassSetupParameter):
%
%   outputPath - Path to the folder where the test results are stored.
%
%   ocuduDFTProcessorUnittest Properties (TestParameter):
%
%   size      - DFT size.
%   direction - DFT direction flag ('direct', 'inverse').
%
%   ocuduDFTProcessorUnittest Methods (TestTags = {'testvector'}):
%
%   testvectorGenerationCases - Generates test vectors according to the provided
%                               parameters.
%
%   ocuduDFTProcessorUnittest Methods (Access = protected):
%
...
classdef ocuduDFTProcessorUnittest < ocuduTest.ocuduBlockUnittest
    properties (Constant)
        %Name of the tested block.
        ocuduBlock = 'dft_processor'

        %Type of the tested block.
        ocuduBlockType = 'phy/generic_functions'
    end
...
end % of classdef ocuduDFTProcessorUnittest
