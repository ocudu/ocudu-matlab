%ocuduPDCCHProcessorUnittest Unit tests for PDCCH processor functions.
%   This class implements unit tests for the PDCCH processor functions using the
%   matlab.unittest framework. The simplest use consists in creating an object with
%       testCase = ocuduPDCCHProcessorUnittest
%   and then running all the tests with
%       testResults = testCase.run
%
%   ocuduPDCCHProcessorUnittest Properties (Constant):
%
%   ocuduBlock      - The tested block (i.e., 'pddch_modulator').
...
%
%   ocuduPDCCHProcessorUnittest Properties (ClassSetupParameter):
%
%   outputPath - Path to the folder where the test results are stored.
%
%   ocuduPDCCHProcessorUnittest Properties (TestParameter):
%
%   Duration         - CORESET Duration.
%   CCEREGMapping    - CCE-to-REG mapping.
%   AggregationLevel - PDCCH aggregation level.
%
%   ocuduPDCCHProcessorUnittest Methods (TestTags = {'testvector'}):
%
%   testvectorGenerationCases - Generates a test vector according to the provided
%                               parameters.
%
%   ocuduPDCCHProcessorUnittest Methods (Access = protected):
%
...
classdef ocuduPDCCHProcessorUnittest < ocuduTest.ocuduBlockUnittest
    properties (Constant)
        %Name of the tested block.
        ocuduBlock = 'pdcch_processor'
    ...
    methods (Test, TestTags = {'testvector'})
        ...
        import ocuduLib.phy.upper.channel_processors.ocuduPDCCHmodulator
        import ocuduLib.phy.upper.signal_processors.ocuduPDCCHDMRS
        import ocuduLib.ran.pdcch.ocuduPDCCHCandidatesUE
        ...
        candidatesCCE = ocuduPDCCHCandidatesUE(coreset.NCCE, numCandidates(AggregationLevelIndex), AggregationLevel, coreset.CORESETID, RNTI, carrier.NSlot);
        ...
        [dataSymbols, dataIndices] = ocuduPDCCHmodulator(encodedMsg, carrier, pdcch, DMRSScramblingID, RNTI);

        % Call the PDCCH DM-RS symbol processor MATLAB functions.
        [dmrsSymbols, dmrsIndices] = ocuduPDCCHDMRS(carrier, pdcch);
...
end % of classdef ocuduPDCCHProcessorUnittest< ocuduTest.ocuduBlockUnittest
