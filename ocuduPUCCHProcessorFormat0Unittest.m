%ocuduPUCCHProcessorFormat0Unittest Unit tests for PUCCH Format 0 processor function.
%   This class implements unit tests for the PUCCH Format 0 processor function using the
%   matlab.unittest framework. The simplest use consists in creating an object with
%       testCase = ocuduPUCCHProcessorFormat0Unittest
%   and then running all the tests with
%       testResults = testCase.run
%
%   ocuduPUCCHProcessorFormat0Unittest Properties (Constant):
%
%   ocuduBlock      - The tested block (i.e., 'pucch_processor').
%   ocuduBlockType  - The type of the tested block, including layer
%                     (i.e., 'phy/upper/channel_processors').
%
%   ocuduPUCCHProcessorFormat0Unittest Properties (ClassSetupParameter):
%
%   outputPath - Path to the folder where the test results are stored.
%
%   ocuduPUCCHProcessorFormat0Unittest Properties (TestParameter):
%
...
%                               parameters.
%
%   ocuduPUCCHProcessorFormat0Unittest Methods (TestTags = {'testmex'}):
%
%   mexTest  - Tests the mex wrapper of the OCUDU PUCCH processor for Format 0.
%
%   ocuduPUCCHProcessorFormat0Unittest Methods (Access = protected):
%
...
classdef ocuduPUCCHProcessorFormat0Unittest < ocuduTest.ocuduBlockUnittest
    properties (Constant)
        %Name of the tested block.
        ocuduBlock = 'pucch_processor_format0'
    ...
    methods (Test, TestTags = {'testmex'})
        ...
        %   PRB length.
            ...
            uci = ocudupucch(carrier, pucch, rxGrid, NumHARQAck = payload.nofHarqAck, NumSR = payload.sr);
...
end % of classdef ocuduPUCCHProcessorFormat0Unittest
