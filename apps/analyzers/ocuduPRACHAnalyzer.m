...
%
%      ocuduPRACHAnalyzer(prach, '~/Downloads/ul_symbol_handler', 1391191, 3336);
%
%   Remark: The nrPRACHConfig object can also be created from the logs with the
%   ocuduParseLogs helper function.

% SPDX-FileCopyrightText: Copyright (C) 2021-2026 Software Radio Systems Limited
% SPDX-License-Identifier: BSD-3-Clause-Open-MPI

function ocuduPRACHAnalyzer(prach, filename, offset, prachSize)
    arguments
    ...
    figFrequencyPower = figure("Name", "ocuduPRACHAnalyzer: Frequency domain sequence power");
    tiledlayout('flow');
    figFrequencyPhase = figure("Name", "ocuduPRACHAnalyzer: Frequency domain correlation phase");
    tiledlayout('flow');
    figTime = figure("Name", "ocuduPRACHAnalyzer: Time domain correlation");
    tiledlayout('flow');
