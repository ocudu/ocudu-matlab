...
%
% The OCUDU gNB automates the CSI-RS configuration based on the physical
...
% currently configured in OCUDU.

%% CSI-RS for mobility
% Similar to the previous purpose and not configured in OCUDU.
