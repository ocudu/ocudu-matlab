...
%   for FR1 configurations, and TS38.108 Section 8.4 and TS38.181 Section 8.4, for
%   NTN configurations.
    ...
    methods (Access = private)
        ...
        %Configures a PRACHPERF object based on TestConfig and common parameter values.
            ...
            elseif strcmp(TestConfig.DelayProfile, 'NTN-TDLA100')
                pp.FrequencyOffset = 200;
            else
                error('ocudu_matlab:CheckPRACHConformance', 'Unsupported delay profile %s.', TestConfig.DelayProfile);
...
% format and subcarrier spacing.
    ...
    if strcmp(prachFormat, '0') || strcmp(prachFormat, '2')
...
% NOTE: We comment the configurations that are not yet supported by OCUDU.
    ...
    TestConfig = { ...
        ...
        ... Long PRACH NTN
        struct( ...
            'Name', 'TS38.108 V17.9.0 Table 8.4.2.2-1 Row 1', ...
            'DelayProfile', 'AWGN', ...
            'NRxAnts', 1, ...
            'Format', '0', ...
            'SNR', -12.0 ...
        ...
        struct( ...
            'Name', 'TS38.108 V17.9.0 Table 8.4.2.2-1 Row 2', ...
            'DelayProfile', 'NTN-TDLA100', ...
            'NRxAnts', 1, ...
            'Format', '0', ...
            'SNR', 0.7 ...
        ) ...
        ...
        struct( ...
            'Name', 'TS38.108 V17.9.0 Table 8.4.2.2-1 Row 3', ...
            'DelayProfile', 'AWGN', ...
            'NRxAnts', 2, ...
            'Format', '0', ...
            'SNR', -14.5 ...
        ...
        struct( ...
            'Name', 'TS38.108 V17.9.0 Table 8.4.2.2-1 Row 4', ...
            'DelayProfile', 'NTN-TDLA100', ...
            'NRxAnts', 2, ...
            'Format', '0', ...
            'SNR', -6.8 ...
        ...
        ... Short PRACH 15 kHz NTN
        struct( ...
            'Name', 'TS38.108 V17.9.0 Table 8.4.2.2-2 Row 1', ...
            'DelayProfile', 'AWGN', ...
            'NRxAnts', 1, ...
            'Format', 'B4', ...
            'SNR', -14.6 ...
        ...
        struct( ...
            'Name', 'TS38.108 V17.9.0 Table 8.4.2.2-2 Row 2', ...
            'DelayProfile', 'NTN-TDLA100', ...
            'NRxAnts', 1, ...
            'Format', 'B4', ...
            'SNR', -2.7 ...
        ...
        struct( ...
            'Name', 'TS38.108 V17.9.0 Table 8.4.2.2-2 Row 3', ...
            'DelayProfile', 'AWGN', ...
            'NRxAnts', 2, ...
            'Format', 'B4', ...
            'SNR', -16.8 ...
        ...
        struct( ...
            'Name', 'TS38.108 V17.9.0 Table 8.4.2.2-2 Row 4', ...
            'DelayProfile', 'NTN-TDLA100', ...
            'NRxAnts', 2, ...
            'Format', 'B4', ...
            'SNR', -4.8 ...
        ...
        ... Short PRACH 30 kHz NTN
        struct( ...
            'Name', 'TS38.108 V17.9.0 Table 8.4.2.2-3 Row 1', ...
            'DelayProfile', 'AWGN', ...
            'NRxAnts', 1, ...
            'Format', 'B4', ...
            'SNR', -14.4 ...
        ...
        struct( ...
            'Name', 'TS38.108 V17.9.0 Table 8.4.2.2-3 Row 2', ...
            'DelayProfile', 'NTN-TDLA100', ...
            'NRxAnts', 1, ...
            'Format', 'B4', ...
            'SNR', -4.3 ...
        ...
        struct( ...
            'Name', 'TS38.108 V17.9.0 Table 8.4.2.2-3 Row 3', ...
            'DelayProfile', 'AWGN', ...
            'NRxAnts', 2, ...
            'Format', 'B4', ...
            'SNR', -16.5 ...
        ...
        struct( ...
            'Name', 'TS38.108 V17.9.0 Table 8.4.2.2-3 Row 4', ...
            'DelayProfile', 'NTN-TDLA100', ...
            'NRxAnts', 2, ...
            'Format', 'B4', ...
            'SNR', -10.0 ...
