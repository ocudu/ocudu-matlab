...
%
%   ocuduPDCCHCandidatesCommonUnittest Properties (Constant):
%
%   ocuduBlock      - The tested block (i.e., 'pdcch_candidates_common').
%   ocuduBlockType  - The type of the tested block, including layer
%                     (i.e., 'ran/pdcch').
%
%   ocuduPDCCHCandidatesCommonUnittest Properties (ClassSetupParameter):
%
%   outputPath - Path to the folder where the test results are stored.
%
%   ocuduPDCCHCandidatesCommonUnittest Properties (TestParameter):
%
...
%
%   ocuduPDCCHCandidatesCommonUnittest Methods (TestTags = {'testvector'}):
%
%   testvectorGenerationCases - Generates a test vector according to the provided
%                               parameters.
%
%   ocuduPDCCHCandidatesCommonUnittest Methods (Access = protected):
%
...
classdef ocuduPDCCHCandidatesCommonUnittest < ocuduTest.ocuduBlockUnittest
    properties (Constant)
        %Name of the tested block.
        ocuduBlock = 'pdcch_candidates_common'
    ...
    methods (Test, TestTags = {'testvector'})
        ...
        import ocuduLib.ran.pdcch.ocuduPDCCHCandidatesCommon
