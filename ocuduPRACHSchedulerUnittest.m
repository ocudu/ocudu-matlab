...
%
%   ocuduPRACHSchedulerUnittest Properties (Constant):
%
%   ocuduBlock                - The tested block (i.e., 'prach_scheduler').
...
%                               frequency occasions.
%
%   ocuduPRACHSchedulerUnittest Properties (ClassSetupParameter):
%
%   outputPath - Path to the folder where the test results are stored.
%
%   ocuduPRACHSchedulerUnittest Properties (TestParameter):
%
%   DuplexMode          - Duplexing mode FDD, TDD, or TDD-FR2.
%   ConfigurationIndex  - PRACH configuration index.
%
%   ocuduPRACHSchedulerUnittest Methods (TestTags = {'testvector'}):
%
%   testvectorGenerationCases - Generates a test vector according to the
%                               provided parameters.
%
%   ocuduPRACHSchedulerUnittest Methods (Access = protected):
%
...
classdef ocuduPRACHSchedulerUnittest < ocuduTest.ocuduBlockUnittest
    properties (Constant)
        %Name of the tested block.
        ocuduBlock = 'prach_scheduler'

        %Type of the tested block.
        ocuduBlockType = 'scheduler/common_scheduling'
...
end % of classdef ocuduPRACHSchedulerUnittest
