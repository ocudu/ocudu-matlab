...
%
%   ocuduPDCCHCandidatesUeUnittest Properties (Constant):
%
%   ocuduBlock      - The tested block (i.e., 'pdcch_candidates_ue').
%   ocuduBlockType  - The type of the tested block, including layer
%                     (i.e., 'ran/pdcch').
%
%   ocuduPDCCHCandidatesUeUnittest Properties (ClassSetupParameter):
%
%   outputPath - Path to the folder where the test results are stored.
%
%   ocuduPDCCHCandidatesUeUnittest Properties (TestParameter):
%
...
%
%   ocuduPDCCHCandidatesUeUnittest Methods (TestTags = {'testvector'}):
%
%   testvectorGenerationCases - Generates a test vector according to the provided
%                               parameters.
%
%   ocuduPDCCHCandidatesUeUnittest Methods (Access = protected):
%
...
classdef ocuduPDCCHCandidatesUeUnittest < ocuduTest.ocuduBlockUnittest
    properties (Constant)
        %Name of the tested block.
        ocuduBlock = 'pdcch_candidates_ue'

        %Type of the tested block.
        ocuduBlockType = 'ran/pdcch'
    end
    ...
    methods (Access = protected)
        ...
        %addTestIncludesToHeaderFile Adds include directives to the test header file.
            ...
            fprintf(fileID, '#include "ocudu/ran/pdcch/pdcch_candidates.h"\n');
        end
    ...
    methods (Test, TestTags = {'testvector'})
        ...
        candidates = ocuduPDCCHCandidatesUE(numCCEs, numCandidates, aggregationLevel, CoresetId, rnti, slotNum);
