%ocuduPUCCHDMRSUnittest Unit tests for PUCCH DM-RS estimator functions.
%   This class implements unit tests for the PUCCH DM-RS estimator functions using the
%   matlab.unittest framework. The simplest use consists in creating an object with
%       testCase = ocuduPUCCHDMRSUnittest
%   and then running all the tests with
%       testResults = testCase.run
%
%   ocuduPUCCHDMRSUnittest Properties (Constant):
%
%   ocuduBlock      - The tested block (i.e., 'dmrs_pucch_estimator').
%   ocuduBlockType  - The type of the tested block, including layer
%                     (i.e., 'phy/upper/signal_processors/pucch').
%
%   ocuduPUCCHDMRSUnittest Properties (ClassSetupParameter):
%
%   outputPath - Path to the folder where the test results are stored.
%
%   ocuduPUCCHDMRSUnittest Properties (TestParameter):
%
...
%
%   ocuduPUCCHDMRSUnittest Methods (TestTags = {'testvector'}):
%
%   testvectorGenerationCases - Generates a test vector according to the provided
%                               parameters.
%
%   ocuduPUCCHDMRSUnittest Methods (Access = protected):
%
...
classdef ocuduPUCCHDMRSUnittest < ocuduTest.ocuduBlockUnittest
    properties (Constant)
        %Name of the tested block.
        ocuduBlock = 'dmrs_pucch_estimator'

        %Type of the tested block.
        ocuduBlockType = 'phy/upper/signal_processors/pucch'
    end
    ...
    properties(Constant, Hidden)
        ...
        %PUCCH format string following ocudu repo API.
        ocuduFormatName = 'pucch_format::FORMAT_';
    ...
    methods (Test, TestTags = {'testvector'})
        ...
        %  while using a random NCellID, random NSlot and random symbol and PRB length.
            ...
            import ocuduLib.phy.upper.signal_processors.ocuduPUCCHDMRS
            import ocuduTest.helpers.writeResourceGridEntryFile
            import ocuduTest.helpers.cellarray2str
            import ocuduTest.helpers.logical2str;
            ...
            [DMRSsymbols, DMRSindices] = ocuduPUCCHDMRS(carrier, pucch);
            ...
            % Group hopping string following ocudu naming.
...
end % of classdef ocuduPUCCHDMRSUnittest
