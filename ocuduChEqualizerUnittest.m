%ocuduChEqualizerUnittest Unit tests for the channel equalizer.
...
%      testCase = ocuduChEqualizerUnittest
%   and then running all the tests with
%      testResults = testCase.run
%
%   ocuduChEqualizerUnittest Properties (Constant):
%
%   ocuduBlock      - The tested block (i.e., 'channel_equalizer').
%   ocuduBlockType  - The type of the tested block, including layer
%                     (i.e., 'phy/upper/equalization').
%
%   ocuduChEqualizerUnittest Properties (ClassSetupParameter):
%
%   outputPath  - Path to the folder where the test results are stored.
%
%   ocuduChEqualizerUnittest Properties (TestParameter):
%
%   channelSize - Channel dimensions, i.e., number of receive ports and
%                 transmit layers.
%   eqType      - Equalization algorithm, either MMSE or ZF.
%
%   ocuduChEqualizerUnittest Methods:
%
%   MSEsimulation - Computes the expected (nominal) and empirical SNR and
%                   MSE achieved by the channel equalizer.
%
%   ocuduChEqualizerUnittest Methods (TestTags = {'testvector'}):
%
%   testvectorGenerationCases - Generates a test vector according to the provided
%                               parameters.
%
%   ocuduChEqualizerUnittest Methods (Access = protected):
%
...
classdef ocuduChEqualizerUnittest < ocuduTest.ocuduBlockUnittest
    properties (Constant)
        %Name of the tested block.
        ocuduBlock = 'channel_equalizer'

        %Type of the tested block, including layers.
        ocuduBlockType = 'phy/upper/equalization'
    end
    ...
    methods (Test, TestTags = {'testvector'})
        ...
        %   data-to-reference amplitude scaling.
            ...
            [eqSymbols, eqNoiseVars] = ocuduChannelEqualizer(approxbf16(rxSymbols), ...
        ...
        function [eqSymbols, txSymbols, rxSymbols, eqNoiseVars] = runCase(obj, eqType, txScaling)
            ...
            for iSymbol = 1 : nSym
                ...
                [eqSymbols(:, iSymbol, :), eqNoiseVars(:, iSymbol, :)] = ...
                    ocuduChannelEqualizer(rxRE, chRE, eqType, noiseVar, txScaling);
            end
...
end % of classdef ocuduChEqualizerUnittest < ocuduTest.ocuduBlockUnittest
