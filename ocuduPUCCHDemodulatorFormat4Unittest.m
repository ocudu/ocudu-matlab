%ocuduPUCCHDemodulatorFormat4Unittest Unit tests for PUCCH Format 4 symbol demodulator functions.
...
%      testCase = ocuduPUCCHDemodulatorFormat4Unittest
%   and then running all the tests with
%      testResults = testCase.run
%
%   ocuduPUCCHDemodulatorFormat4Unittest Properties (Constant):
%
%   ocuduBlock      - The tested block (i.e., 'pucch_demodulator_format4').
%   ocuduBlockType  - The type of the tested block, including layer
%                     (i.e., 'phy/upper/channel_processors/pucch').
%
%   ocuduPUCCHDemodulatorFormat4Unittest Properties (ClassSetupParameter):
%
%   outputPath - Path to the folder where the test results are stored.
%
%   ocuduPUCCHDemodulatorFormat4Unittest Properties (TestParameter):
%
...
%
%   ocuduPUCCHDemodulatorFormat4Unittest Methods (TestTags = {'testvector'}):
%
%   testvectorGenerationCases - Generates a test vector according to the provided
%                               parameters.
%
%   ocuduPUCCHDemodulatorFormat4Unittest Methods (Access = protected):
%
...
classdef ocuduPUCCHDemodulatorFormat4Unittest < ocuduTest.ocuduBlockUnittest
    properties (Constant)
        %Name of the tested block.
        ocuduBlock = 'pucch_demodulator_format4'
    ...
    methods (Access = protected)
        ...
        %addTestIncludesToHeaderFile Adds include directives to the test header file.
            ...
            fprintf(fileID, '#include "ocudu/phy/upper/channel_processors/pucch/pucch_demodulator.h"\n');
    ...
    methods (Test, TestTags = {'testvector'})
        ...
        % DM-RS and modulation parameters.
            ...
            import ocuduLib.phy.upper.channel_processors.pucch.ocuduPUCCH4Demodulator
            ...
            softBits = ocuduPUCCH4Demodulator(carrier, pucch, channelSymbols, dataChEsts, noiseVar);
...
end % of classdef ocuduPUCCHDemodulatorFormat4Unittest
