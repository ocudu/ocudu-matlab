%ocuduLowPAPRSequenceUnittest Unit tests for Low PAPR Sequence generator.
...
%       testCase = ocuduLowPAPRSequenceUnittest
%   and then running all the tests with
%       testResults = testCase.run
%
%   ocuduLowPAPRSequenceUnittest Properties (Constant):
%
%   ocuduBlock      - The tested block (i.e., 'low_papr_sequence_generator').
%   ocuduBlockType  - The type of the tested block, including layer
%                     (i.e., 'phy/upper/sequence_generators').
%
%   ocuduLowPAPRSequenceUnittest Properties (ClassSetupParameter):
%
%   outputPath - Path to the folder where the test results are stored.
%
%   ocuduLowPAPRSequenceUnittest Properties (TestParameter):
%
%   SequenceLength      - Length of the sequence.
%   MaxCyclicShift      - Maximum number of sequence cyclic shifts.
%
%   ocuduLowPAPRSequenceUnittest Methods (TestTags = {'testvector'}):
%
%   testvectorGenerationCases - Generates a test vector according to the
%                               provided parameters.
%
%   ocuduLowPAPRSequenceUnittest Methods (Access = protected):
%
...
classdef ocuduLowPAPRSequenceUnittest < ocuduTest.ocuduBlockUnittest
    properties (Constant)
        %Name of the tested block.
        ocuduBlock = 'low_papr_sequence_generator'

        %Type of the tested block.
        ocuduBlockType = 'phy/upper/sequence_generators'
    end
    ...
    methods (Access = protected)
        ...
        %addTestIncludesToHeaderFile Adds include directives to the test header file.
            ...
            fprintf(fileID, '#include "ocudu/phy/upper/sequence_generators/low_papr_sequence_generator.h"\n');
...
end % of classdef ocuduLowPAPRSequenceUnittest
