...
%   subset of those described in TS38.104 Section 8.3.5 and TS38.141-1 Section 8.3.4
%   (for FR1), TS38.104 Section 11.3.2.5 and TS38.141-2 Section 8.3.4 (for FR2),
%   and TS38.108 Section 8.3.5 and TS38.181 Section 8.3.4 (for NTN FR1).
...
TestConfig = { ...
    ...
    struct( ...
        'Table',             'TS38.104 V15.19.0 Table 11.3.2.5.2-2', ...
    ...
    struct( ...
        'Table',             'TS38.108 V17.4.0 Table 8.3.5.2-1', ...
        'SubcarrierSpacing', 15, ...
        'Test',              1, ...
        'NRxAnts',           1, ...
        'AdditionalDMRS',    false, ...
    ...
    struct( ...
        'Table',             'TS38.108 V17.4.0 Table 8.3.5.2-2', ...
        'SubcarrierSpacing', 30, ...
        'Test',              1, ...
        'NRxAnts',           1, ...
        'AdditionalDMRS',    false, ...
