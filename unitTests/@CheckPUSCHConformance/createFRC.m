...
... transform precoding disabled, Additional DM-RS position = pos0 and
... one transmission layer (QPSK, R=193/1024).
        'G-FR2-A3-3',  struct('SubcarrierSpacing', 120, ...
                              'PRBSet',            0:31, ...
                              'TargetCodeRate',    193/1024, ...
                              'Modulation',        'QPSK'), ...
...
... transform precoding disabled, Additional DM-RS position = pos0 and
... two transmission layers (QPSK, R=193/1024).
        'G-FR2-A3-8',  struct('SubcarrierSpacing', 120, ...
                              'PRBSet',            0:31, ...
                              'TargetCodeRate',    193/1024, ...
                              'Modulation',        'QPSK'), ...
...
... transform precoding disabled, Additional DM-RS position = pos1 and
... one transmission layer (QPSK, R=193/1024).
        'G-FR2-A3-15', struct('SubcarrierSpacing', 120, ...
                              'PRBSet',            0:31, ...
                              'TargetCodeRate',    193/1024, ...
                              'Modulation',        'QPSK'), ...
...
... transform precoding disabled, Additional DM-RS position = pos1 and
... two transmission layers (QPSK, R=193/1024).
        'G-FR2-A3-20', struct('SubcarrierSpacing', 120, ...
                              'PRBSet',            0:31, ...
                              'TargetCodeRate',    193/1024, ...
                              'Modulation',        'QPSK'), ...
...
... two transmission layers (16QAM, R=658/1024)
        ...
        'G-FR1-A4-28', struct('SubcarrierSpacing', 30, ...
                              ...
                              'TargetCodeRate',    658/1024, ...
                              'Modulation',        '16QAM'), ...
... Table A.4-5: FRC parameters for FR2 PUSCH performance requirements,
... transform precoding disabled, Additional DM-RS position = pos0 and
... one transmission layer (16QAM, R=658/1024).
        'G-FR2-A4-3',  struct('SubcarrierSpacing', 120, ...
                              'PRBSet',            0:31, ...
                              'TargetCodeRate',    658/1024, ...
                              'Modulation',        '16QAM'), ...
... Table A.4-6: FRC parameters for FR2 PUSCH performance requirements,
... transform precoding disabled, Additional DM-RS position = pos0 and
... two transmission layers (16QAM, R=658/1024).
        'G-FR2-A4-8',  struct('SubcarrierSpacing', 120, ...
                              'PRBSet',            0:31, ...
                              'TargetCodeRate',    658/1024, ...
                              'Modulation',        '16QAM'), ...
... Table A.4-7: FRC parameters for FR2 PUSCH performance requirements,
... transform precoding disabled, Additional DM-RS position = pos1 and
... one transmission layer (16QAM, R=658/1024).
        'G-FR2-A4-13', struct('SubcarrierSpacing', 120, ...
                              'PRBSet',            0:31, ...
                              'TargetCodeRate',    658/1024, ...
                              'Modulation',        '16QAM'), ...
... Table A.4-8: FRC parameters for FR2 PUSCH performance requirements,
... transform precoding disabled, Additional DM-RS position = pos1 and
... two transmission layers (16QAM, R=658/1024).
        'G-FR2-A4-18', struct('SubcarrierSpacing', 120, ...
                              'PRBSet',            0:31, ...
                              'TargetCodeRate',    658/1024, ...
                              'Modulation',        '16QAM'), ...
...
... one transmission layer (64QAM, R=567/1024)
        ...
        'G-FR1-A5-14', struct('SubcarrierSpacing', 30, ...
                              ...
                              'TargetCodeRate',    567/1024, ...
                              'Modulation',        '64QAM'), ...
... Table A.5-3: FRC parameters for FR2 PUSCH performance requirements,
... transform precoding disabled, Additional DM-RS position = pos0 and
... one transmission layer (64QAM, R=567/1024).
        'G-FR2-A5-3',  struct('SubcarrierSpacing', 120, ...
                              'PRBSet',            0:31, ...
                              'TargetCodeRate',    567/1024, ...
                              'Modulation',        '64QAM'), ...
... Table A.5-8: FRC parameters for FR2 PUSCH performance requirements,
... transform precoding disabled, Additional DM-RS position = pos1 and
... one transmission layer (64QAM, R=567/1024).
        'G-FR2-A5-8',  struct('SubcarrierSpacing', 120, ...
                              'PRBSet',            0:31, ...
                              'TargetCodeRate',    567/1024, ...
                              'Modulation',        '64QAM'), ...
