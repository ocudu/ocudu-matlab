%ocuduPUSCHDecoder MATLAB interface to OCUDU PUSCH decoder.
%   User-friendly interface to the OCUDU PUSCH decoder class, which is wrapped
%   by the MEX static method pusch_decoder_mex.
%
%   PUSCHDEC = ocuduPUSCHDecoder creates a PHY Uplink Shared Channel decoder
%   object, PUSCHDEC, with the default configuration.
%
%   PUSCHDEC = ocuduPUSCHDecoder(Name, Value) creates a PUSCH decoder object,
%   PUSCHDEC, with the specified property Name set to the specified Value.
%   You can specify additional name-value pair arguments in any order as
%   (Name1, Value1, Name2, Value2, ..., NameN, ValueN).
%
%   ocuduPUSCHDecoder Properties (Nontunable):
%
...
%
%   ocuduPUSCHDecoder Properties (Access = private):
%
%   SoftbufferPoolID          - Identifier of the softbuffer pool.
%
%   ocuduPUSCHDecoder Methods:
%
...
classdef ocuduPUSCHDecoder < matlab.System
    ...
    methods
        function obj = ocuduPUSCHDecoder(varargin)
        ...
        %      NumCodeblocks  - the number of codeblocks forming the codeword.
            ...
            arguments
                obj       (1, 1) ocuduMEX.phy.ocuduPUSCHDecoder
    ...
    methods (Access = protected)
        ...
        function [transportBlock, stats] = stepImpl(obj, llrs, newData, segConfig, harqBufID, dataType)
           ...
           if strcmp(dataType, 'unpacked')
               transportBlock = ocuduTest.helpers.bitUnpack(transportBlock);
           end
        ...
        % Loads an ocuduPUSCHDecoder object from a file.
...
end % of classdef ocuduPUSCHDecoder < matlab.System
