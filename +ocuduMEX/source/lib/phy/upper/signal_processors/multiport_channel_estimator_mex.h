...
inline std::unique_ptr<ocudu::port_channel_estimator>
create_port_channel_estimator(ocudu::port_channel_estimator_fd_smoothing_strategy smoothing, bool compensate_cfo);

/// Implements a SIMO channel estimator leveraging OCUDU \c port_channel_estimator.
...
private:
  ...
  ///
  /// This method creates the OCUDU channel estimator object used by the multiport estimator. The channel estimator is
  ...
  std::unique_ptr<ocudu::port_channel_estimator> estimator = nullptr;
};

inline std::unique_ptr<ocudu::port_channel_estimator>
create_port_channel_estimator(ocudu::port_channel_estimator_fd_smoothing_strategy     fd_smoothing,
                              ocudu::port_channel_estimator_td_interpolation_strategy td_interpolation,
                              bool                                                    compensate_cfo)
{
