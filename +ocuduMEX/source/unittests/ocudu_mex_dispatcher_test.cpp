...
/// \file
/// \brief ocudu_mex_dispatcher unit test.
///
/// This file defines a class that derives from ocudu_mex_dispatcher with two simple methods. Once the mex is built,
...
/// Example MexFunction class inherited from ocudu_mex_dispatcher.
