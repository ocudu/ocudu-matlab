...
/// in the constructor.
///
/// All the methods managed by the dispatcher should take the same arguments as ocudu_mex_dispatcher::operator()().
class ocudu_mex_dispatcher : public matlab::mex::Function
{
public:
