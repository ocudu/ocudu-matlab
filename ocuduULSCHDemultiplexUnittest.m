...
%
%   ocuduULSCHDemultiplexUnittest Properties (Constant):
%
%   ocuduBlock      - The tested block (i.e., 'ulsch_demultiplex').
%   ocuduBlockType  - The type of the tested block, including layer
%                     (i.e., 'phy/upper/channel_processors/pusch').
%
%   ocuduULSCHDemultiplexUnittest Properties (ClassSetupParameter):
%
%   outputPath - Path to the folder where the test results are stored.
%
%   ocuduULSCHDemultiplexUnittest Properties (TestParameter):
%
...
%
%   ocuduULSCHDemultiplexUnittest Methods (TestTags = {'testvector'}):
%
%   testvectorGenerationCases - Generates a test vector according to the provided
%                               parameters.
%
%   ocuduULSCHDemultiplexUnittest Methods (Access = protected):
%
...
classdef ocuduULSCHDemultiplexUnittest < ocuduTest.ocuduBlockUnittest
    properties (Constant)
        %Name of the tested block.
        ocuduBlock = 'ulsch_demultiplex'
    ...
    methods (Access = protected)
        ...
        %addTestIncludesToHeaderFile Adds include directives to the test header file.
            ...
            fprintf(fileID, '#include "ocudu/phy/upper/channel_processors/pusch/ulsch_demultiplex.h"\n');
    ...
    methods (Test, TestTags = {'testvector'})
        ...
        %   nofCsiPart1Bits and nofCsiPart2Bits.
            ...
            import ocuduLib.phy.upper.channel_processors.pusch.ocuduULSCHScramblingPlaceholders
            ...
            [xInd, yInd] = ocuduULSCHScramblingPlaceholders(pusch, ...
