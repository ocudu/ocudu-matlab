%ocuduSSBProcessorUnittest Unit tests for SSB processor functions.
%   This class implements unit tests for the SSB processor functions using the
%   matlab.unittest framework. The simplest use consists in creating an object with
%      testCase = ocuduSSBProcessorUnittest
%   and then running all the tests with
%      testResults = testCase.run
%
%   ocuduSSBProcessorUnittest Properties (Constant):
%
%   ocuduBlock      - The tested block (i.e., 'ssb_processor').
%   ocuduBlockType  - The type of the tested block, including layer
%                     (i.e., 'phy/upper/channel_processors/ssb').
%
%   ocuduSSBProcessorUnittest Properties (ClassSetupParameter):
%
%   outputPath - Path to the folder where the test results are stored.
%
%   ocuduSSBProcessorUnittest Properties (TestParameter):
%
...
%
%   ocuduSSBProcessorUnittest Methods (Test, TestTags = {'testvector'}):
%
...
%
%   ocuduSSBProcessorUnittest Methods (Access = protected):
%
...
classdef ocuduSSBProcessorUnittest < ocuduTest.ocuduBlockUnittest
    properties (Constant)
        %Name of the tested block.
        ocuduBlock = 'ssb_processor'
    ...
    methods (Test, TestTags = {'testvector'})
        ...
        %   random NCellID and a random codeword.
            ...
            import ocuduLib.phy.upper.signal_processors.ocuduPSS
            import ocuduLib.phy.upper.signal_processors.ocuduSSS
            ...
            if isPatternOK && isSSBindexOK
                ...
                numerology = ocuduSSBgetNumerology(SSBpattern);
                ...
                SSBfirstSymbolIndex = ocuduSSBgetFirstSymbolIndex(SSBpattern, SSBindex);
                ...
                cw = ocuduPBCHencoder(randomMIB, NCellIDLoc, SSBindex, Lmax, SFNLoc, nHF, SSBoffset);

                % Call the PSS generation MATLAB functions and adjust the SSB indexing offsets.
                [PSSsymbols, PSSindices] = ocuduPSS(NCellIDLoc);
                ...
                [SSSsymbols, SSSindices] = ocuduSSS(NCellIDLoc);
                ...
                [PBCHsymbols, PBCHindices] = ocuduPBCHmodulator(cw, NCellIDLoc, SSBindex, Lmax);
                ...
                [PBCHdmrsSymbols, PBCHdmrsIndices] = ocuduPBCHDMRS(NCellIDLoc, SSBindex, Lmax, nHF);
...
end % of classdef ocuduSSBProcessorUnittest
