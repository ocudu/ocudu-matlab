...
%
%   ocuduPBCHDMRSUnittest Properties (Constant):
%
%   ocuduBlock      - The tested block (i.e., 'dmrs_pbch_processor').
%   ocuduBlockType  - The type of the tested block, including layer
%                     (i.e., 'phy/upper/signal_processors/ssb').
%
%   ocuduPBCHDMRSUnittest Properties (ClassSetupParameter):
%
%   outputPath - Path to the folder where the test results are stored.
%
%   ocuduPBCHDMRSUnittest Properties (TestParameter):
%
...
%
%   ocuduPBCHDMRSUnittest Methods (TestTags = {'testvector'}):
%
...
classdef ocuduPBCHDMRSUnittest < ocuduTest.ocuduBlockUnittest
    properties (Constant)
        %Name of the tested block.
        ocuduBlock = 'dmrs_pbch_processor'

        %Type of the tested block.
        ocuduBlockType = 'phy/upper/signal_processors/ssb'
    end
...
end % of classdef ocuduPBCHDMRSUnittest
