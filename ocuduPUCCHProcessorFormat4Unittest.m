%ocuduPUCCHProcessorFormat4Unittest Unit tests for PUCCH Format 4 processor function.
%   This class implements unit tests for the PUCCH Format 4 processor function using the
%   matlab.unittest framework. The simplest use consists in creating an object with
%       testCase = ocuduPUCCHProcessorFormat4Unittest
%   and then running all the tests with
%       testResults = testCase.run
%
%   ocuduPUCCHProcessorFormat4Unittest Properties (Constant):
%
%   ocuduBlock      - The tested block (i.e., 'pucch_processor_format4').
%   ocuduBlockType  - The type of the tested block, including layer
%                     (i.e., 'phy/upper/channel_processors/pucch').
%
%   ocuduPUCCHProcessorFormat4Unittest Properties (ClassSetupParameter):
%
%   outputPath - Path to the folder where the test results are stored.
%
%   ocuduPUCCHProcessorFormat4Unittest Properties (TestParameter):
%
...
%
%   ocuduPUCCHProcessorFormat4Unittest Methods (TestTags = {'testvector'}):
%
%   testvectorGenerationCases - Generates a test vector according to the provided
%                               parameters.
%
%   ocuduPUCCHProcessorFormat4Unittest Methods (Access = protected):
%
...
classdef ocuduPUCCHProcessorFormat4Unittest < ocuduTest.ocuduBlockUnittest
    properties (Constant)
        %Name of the tested block.
        ocuduBlock = 'pucch_processor_format4'
    ...
    methods (Access = private)
        ...
        % Sets secondary simulation variables and MATLAB NR configuration objects.
            ...
            assert(nofUCIBits >= 3, ...
                'ocudu_matlab:ocuduPUCCHProcessorFormat4Unittest', ...
    ...
    methods (Test, TestTags = {'testmex'})
        function mexTest(testCase, SymbolAllocation, FrequencyHopping, ...
                CodeRate)
        %mexTest  Tests the mex wrapper of the OCUDU PUCCH processor for Format 4.
...
end % of classdef ocuduPUCCHProcessorFormat4Unittest
