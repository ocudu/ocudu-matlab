%ocuduTPMISelect Selects a transmission precoding matrix indicator for PUSCH transmissions.
%
%   INFO = ocuduTPMISelect(H, CodebookSubset, NoiseVar) selects the best
...
function info = ocuduTPMISelect(H, CodebookSubset, NoiseVar)
arguments
