...
%        of bits.
%     [results, epre, noiseVar] = ocuduPUCCH1Detector(___) also returns the
...
function [results, epre, noiseVar] = ocuduPUCCH1Detector(carrier, pucch, rxGrid, lastInput)
    arguments
    ...
    elseif isstruct(lastInput)
        ...
        eidType = 'ocuduPUCCH1Detector:wrongInput';
...
end % of function ocuduPUCCH1Detector()
