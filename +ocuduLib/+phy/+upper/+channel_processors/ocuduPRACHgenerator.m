%ocuduPRACHgenerator Generate a 5G NR PRACH waveform.
%   [WAVEFORM,GRIDSET,INFO] = ocuduPRACHgenerator(CARRIER, PRACH)
...
function [waveform,gridset,winfo] = ocuduPRACHgenerator(carrier, prach)
