%ocuduChannelEstimator channel estimation.
%   [CHANNELESTRG, NOISEEST, RSRP, EPRE, TIMEALIGNMENT, CFO] = ocuduChannelEstimator(RECEIVEDRG, PILOTS, BETADMRS, HOP1, HOP2, CONFIG)
...
function [channelEstRG, noiseEst, rsrp, epre, timeAlignment, cfo] = ...
    ocuduChannelEstimator(receivedRG, pilots, betaDMRS, hop1, hop2, config)
...
end % of function ocuduChannelEstimator
