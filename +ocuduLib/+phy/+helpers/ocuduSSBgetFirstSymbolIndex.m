%ocuduSSBgetFirstSymbolIndex Calculates the first OFDM symbol in a 5ms SS/PBCH block burst.
%   SSBFIRSTSYMBOLINDEX = ocuduSSBgetFirstSymbolIndex(SSBPATTERN, SSBINDEX, CARRIERFREQ)
...
function SSBfirstSymbolIndex = ocuduSSBgetFirstSymbolIndex(SSBpattern, SSBindex, ~)
