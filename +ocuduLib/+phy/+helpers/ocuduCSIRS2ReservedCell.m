%ocuduCSIRS2ReservedCell Generates a cell array that describes a reserved RE pattern.
%   RESERVEDLIST = ocuduCSIRS2ReservedCell(CARRIER, CSIRSRESOURCES) Generates
...
%
%      reservedPattern = ocuduCSIRS2ReservedCell(carrier, CSIRSResources);
%
...
function reservedList = ocuduCSIRS2ReservedCell(carrier,CSIRSResources)
...
end % of function reservedList = ocuduCSIRS2ReservedCell...
