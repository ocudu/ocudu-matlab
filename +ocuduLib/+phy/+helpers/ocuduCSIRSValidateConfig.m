%ocuduCSIRSValidateConfig CSI-RS configuration validator.
%   ISVALID = ocuduCSIRSValidateConfig(NRCARRIER, CSIRSCONFIG) checks whether
...
function isValid = ocuduCSIRSValidateConfig(nrCarrier, CSIRSConfig)
