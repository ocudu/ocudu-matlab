...
%      testCase = ocuduPUSCHProcessorUnittest
%   and then running all the tests with
%      testResults = testCase.run
%
%   ocuduPUSCHProcessorUnittest Properties (Constant):
%
%   ocuduBlock      - The tested block (i.e., 'pusch_processor').
%   ocuduBlockType  - The type of the tested block, including layer
%                     (i.e., 'phy/upper/channel_processors/pusch').
%
%   ocuduPUSCHProcessorUnittest Properties (ClassSetupParameter):
%
%   outputPath - Path to the folder where the test results are stored.
%
%   ocuduPUSCHProcessorUnittest Properties (TestParameter):
%
...
%
%   ocuduPUSCHProcessorUnittest Methods (TestTags = {'testvector'}):
%
%   testvectorGenerationCases - Generates a test vector according to the provided
%                               parameters.
%
%   ocuduPUSCHProcessorUnittest Methods (Access = protected):
%
...
classdef ocuduPUSCHProcessorUnittest < ocuduTest.ocuduBlockUnittest
    properties (Constant)
        %Name of the tested block.
        ocuduBlock = 'pusch_processor'
    ...
    methods (Access = protected)
        ...
        %addTestIncludesToHeaderFile Adds include directives to the test header file.
            ...
            fprintf(fileID, '#include "ocudu/phy/upper/channel_processors/pusch/pusch_processor.h"\n');
            fprintf(fileID, '#include "ocudu/support/file_vector.h"\n');
            fprintf(fileID, '#include "ocudu/phy/upper/channel_estimation.h"\n');
        end
