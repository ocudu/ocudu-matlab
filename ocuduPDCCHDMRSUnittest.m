...
%
%   ocuduPDCCHDMRSUnittest Properties (Constant):
%
%   ocuduBlock      - The tested block (i.e., 'dmrs_pdcch_processor').
%   ocuduBlockType  - The type of the tested block, including layer
%                     (i.e., 'phy/upper/signal_processors/pdcch').
%
%   ocuduPDCCHDMRSUnittest Properties (ClassSetupParameter):
%
%   outputPath - Path to the folder where the test results are stored.
%
%   ocuduPDCCHDMRSUnittest Properties (TestParameter):
%
...
%
%   ocuduPDCCHDMRSUnittest Methods (TestTags = {'testvector'}):
%
%   testvectorGenerationCases - Generates a test vector according to the provided
%                               parameters.
%
%   ocuduPBCHDMRSUnittest Methods (Access = protected):
%
...
classdef ocuduPDCCHDMRSUnittest < ocuduTest.ocuduBlockUnittest
    properties (Constant)
        %Name of the tested block.
        ocuduBlock = 'dmrs_pdcch_processor'

        %Type of the tested block.
        ocuduBlockType = 'phy/upper/signal_processors/pdcch'
    end
    ...
    methods (Test, TestTags = {'testvector'})
        ...
        %   CCEREGMapping and AggregationLevel, while using a random NCellID and a random NSlot.
            ...
            import ocuduLib.phy.helpers.ocuduGetUniqueSymbolsIndices
...
end % of classdef ocuduPDCCHDMRSUnittest
