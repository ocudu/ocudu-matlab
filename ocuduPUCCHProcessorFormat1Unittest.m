%ocuduPUCCHProcessorFormat1Unittest Unit tests for PUCCH Format 1 processor function.
%   This class implements unit tests for the PUCCH Format 1 processor function using the
%   matlab.unittest framework. The simplest use consists in creating an object with
%       testCase = ocuduPUCCHProcessorFormat1Unittest
%   and then running all the tests with
%       testResults = testCase.run
%
%   ocuduPUCCHProcessorFormat1Unittest Properties (Constant):
%
%   ocuduBlock      - The tested block (i.e., 'pucch_processor').
%   ocuduBlockType  - The type of the tested block, including layer
%                     (i.e., 'phy/upper/channel_processors').
%
%   ocuduPUCCHProcessorFormat1Unittest Properties (ClassSetupParameter):
%
...
%
%   ocuduPUCCHProcessorFormat1Unittest Methods (TestTags = {'testvector'}):
%
%   testvectorGenerationCases - Generates a test vector according to the provided
%                               parameters.
%
%   ocuduPUCCHProcessorFormat1Unittest Methods (Test, TestTags = {'testmex'}):
%
%   mexTest  - Tests the MEX-based implementation of the PUCCH Format 1 processor.
%
%   ocuduPUCCHProcessorFormat1Unittest Methods (Access = protected):
%
...
classdef ocuduPUCCHProcessorFormat1Unittest < ocuduTest.ocuduBlockUnittest
    properties (Constant)
        %Name of the tested block.
        ocuduBlock = 'pucch_processor_format1'
    ...
    methods (Test, TestTags = {'testvector'})
        ...
        %   parameters are set randomly.
            ...
            import ocuduLib.phy.upper.channel_processors.pucch.ocuduPUCCH1Detector
            ...
            [results, epre, noiseVar] = ocuduPUCCH1Detector(carrier, pucchCommon, approxbf16(rxGrid), pucchListIn);
            ...
            cyclicPrefixConfig = matlab2ocuduCyclicPrefix(cyclicPrefix);
    ...
    methods (Test, TestTags = {'testmex'})
        ...
        %mexTest Tests the mex wrapper of the OCUDU PUCCH processor for Format 1.
        ...
        %   The remaining parameters are set randomly.
            ...
            import ocuduMEX.phy.ocuduPUCCHProcessor
            import ocuduTest.helpers.approxbf16
            ...
            ocudupucch = ocuduPUCCHProcessor;

            carrier = configuration.Carrier;
            pucchCommon = configuration.PUCCH;
            uci = ocudupucch(carrier, pucchCommon, approxbf16(rxGrid), MuxFormat1=pucchListIn);
...
end % of classdef ocuduPUCCHProcessorFormat1Unittest
