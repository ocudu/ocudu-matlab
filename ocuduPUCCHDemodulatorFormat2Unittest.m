%ocuduPUCCHDemodulatorFormat2Unittest Unit tests for PUCCH Format 2 symbol demodulator functions.
...
%      testCase = ocuduPUCCHDemodulatorFormat2Unittest
%   and then running all the tests with
%      testResults = testCase.run
%
%   ocuduPUCCHDemodulatorFormat2Unittest Properties (Constant):
%
%   ocuduBlock      - The tested block (i.e., 'pucch_demodulator_format2').
%   ocuduBlockType  - The type of the tested block, including layer
%                     (i.e., 'phy/upper/channel_processors').
%
%   ocuduPUCCHDemodulatorFormat2Unittest Properties (ClassSetupParameter):
%
%   outputPath - Path to the folder where the test results are stored.
%
%   ocuduPUCCHDemodulatorFormat2Unittest Properties (TestParameter):
%
%   SymbolAllocation  - Symbols allocated to the PUCCH transmission.
%
%   PRBNum - Number of contiguous PRB allocated to PUCCH Format 2.
%
%   ocuduPUCCHDemodulatorFormat2Unittest Methods (TestTags = {'testvector'}):
%
%   testvectorGenerationCases - Generates a test vector according to the provided
%                               parameters.
%
%   ocuduPUCCHDemodulatorFormat2Unittest Methods (Access = protected):
%
...
classdef ocuduPUCCHDemodulatorFormat2Unittest < ocuduTest.ocuduBlockUnittest
    properties (Constant)
        %Name of the tested block.
        ocuduBlock = 'pucch_demodulator_format2'
    ...
    methods (Test, TestTags = {'testvector'})
        ...
        % Fixed Reference Channel.
            ...
            [eqSymbols, eqNoiseVars] = ocuduChannelEqualizer(channelSymbols, dataChEsts, 'ZF', noiseVar, 1);
...
end % of classdef ocuduPUCCHDemodulatorFormat2Unittest
