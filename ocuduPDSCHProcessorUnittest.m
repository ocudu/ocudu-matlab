%ocuduPDSCHProcessorUnittest Vector tests for PDSCH processor functions.
...
%      testCase = ocuduPDSCHProcessorUnittest
%   and then running all the tests with
%      testResults = testCase.run
%
%   ocuduPDSCHProcessorUnittest Properties (Constant):
%
%   ocuduBlock      - The tested block (i.e., 'pdsch_processor').
%   ocuduBlockType  - The type of the tested block, including layer
%                     (i.e., 'phy/upper').
%
%   ocuduPDSCHProcessorUnittest Properties (ClassSetupParameter):
%
%   outputPath - Path to the folder where the test results are stored.
%
%   ocuduPDSCHProcessorUnittest Properties (TestParameter):
%
...
%
%   ocuduPDSCHProcessorUnittest Methods (TestTags = {'testvector'}):
%
%   testvectorGenerationCases - Generates a test vectors according to the provided
%                               parameters.
%
%   ocuduPDSCHProcessorUnittest Methods (Access = protected):
%
...
classdef ocuduPDSCHProcessorUnittest < ocuduTest.ocuduBlockUnittest
    properties (Constant)
        %Name of the tested block.
        ocuduBlock = 'pdsch_processor'
    ...
    methods (Test, TestTags = {'testvector'})
        ...
        %   generated.
            ...
            import ocuduLib.phy.helpers.ocuduCSIRS2ReservedCell
            ...
            if ((~ocuduCSIRSValidateConfig(carrier, csirs1)) || ...
                    (~ocuduCSIRSValidateConfig(carrier, csirs2)) || ...
                    (~ocuduCSIRSValidateConfig(carrier, csirs3)))
                error('invalid CSIRS configuration');
            end

            % Generate RE patterns from the CSI-RS resources.
            rvdREPatternList = ocuduCSIRS2ReservedCell(carrier, {csirs1, csirs2, csirs3});
...
end % of classdef ocuduPDSCHProcessorUnittest
