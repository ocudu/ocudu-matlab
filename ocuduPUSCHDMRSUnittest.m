...
%
%   ocuduPUSCHDMRSUnittest Properties (Constant):
%
%   ocuduBlock      - The tested block (i.e., 'dmrs_pusch_estimator').
%   ocuduBlockType  - The type of the tested block, including layer
%                     (i.e., 'phy/upper/signal_processors/pusch').
%
%   ocuduPUSCHDMRSUnittest Properties (ClassSetupParameter):
%
%   outputPath - Path to the folder where the test results are stored.
%
%   ocuduPUSCHDMRSUnittest Properties (TestParameter):
%
...
%                               parameters.
%
%   ocuduPUSCHDMRSUnittest Methods (Access = protected):
%
...
classdef ocuduPUSCHDMRSUnittest < ocuduTest.ocuduBlockUnittest
    properties (Constant)
        %Name of the tested block.
        ocuduBlock = 'dmrs_pusch_estimator'

        %Type of the tested block.
        ocuduBlockType = 'phy/upper/signal_processors/pusch'
    ...
    methods (Access = protected)
        ...
        %addTestIncludesToHeaderFile Adds include directives to the test header file.
            ...
            fprintf(fileID, '#include "ocudu/phy/upper/signal_processors/pusch/dmrs_pusch_estimator.h"\n');
...
end % of classdef ocuduPUSCHDMRSUnittest
