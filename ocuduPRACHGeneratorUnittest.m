%ocuduPRACHGeneratorUnittest Unit tests for PRACH waveform generator.
...
%       testCase = ocuduPRACHGeneratorUnittest
%   and then running all the tests with
%       testResults = testCase.run
%
%   ocuduPRACHGeneratorUnittest Properties (Constant):
%
%   ocuduBlock      - The tested block (i.e., 'prach_generator').
%   ocuduBlockType  - The type of the tested block, including layer
%                     (i.e., 'phy/upper/channel_processors').
%
%   ocuduPRACHGeneratorUnittest Properties (ClassSetupParameter):
%
%   outputPath - Path to the folder where the test results are stored.
%
%   ocuduPRACHGeneratorUnittest Properties (TestParameter):
%
...
%
%   ocuduPRACHGeneratorUnittest Methods (TestTags = {'testvector'}):
%
%   testvectorGenerationCases - Generates a test vectors according to the provided
%                               parameters.
%
%   ocuduPRACHGeneratorUnittest Methods (Access = protected):
%
...
classdef ocuduPRACHGeneratorUnittest < ocuduTest.ocuduBlockUnittest
    properties (Constant)
    ...
    methods (Test, TestTags = {'testvector'})
        ...
        %and PreambleIndex are generated randomly.
            ...
            prach = ocuduConfigurePRACH(PreambleFormat, ...
            ...
            testCaseString = testCase.testCaseToString(TestID, ...
                ocuduPRACHConfig, true, '_test_output');

            % Add the test to the file header
            testCase.addTestToHeaderFile(testCase.headerFileID, testCaseString);
        end % of function testvectorGenerationCases
    end % of methods (Test, TestTags = {'testvector'})
end % of classdef ocuduPRACHGeneratorUnittest
