...
%
%   ocuduTPMISelectUnittest Properties (Constant):
%
%   ocuduBlock      - The tested block (i.e., 'pusch_tpmi_select').
%   ocuduBlockType  - The type of the tested block, including layer
%                     (i.e., 'ran/pusch').
%
%   ocuduTPMISelectUnittest Properties (ClassSetupParameter):
%
%   outputPath - Path to the folder where the test results are stored.
%
%   ocuduTPMISelectUnittest Properties (TestParameter):
%
...
%                               parameters.
%
%   ocuduTPMISelectUnittest Methods (Access = protected):
%
...
classdef ocuduTPMISelectUnittest < ocuduTest.ocuduBlockUnittest
    properties (Constant)
        %Name of the tested block.
        ocuduBlock = 'pusch_tpmi_select'
    ...
    methods (Access = protected)
        ...
        %addTestIncludesToHeaderFile Adds include directives to the test header file.
            ...
            fprintf(fileID, '#include "ocudu/ran/pusch/pusch_tpmi_select.h"\n');
            fprintf(fileID, '#include "ocudu/ran/srs/srs_channel_matrix.h"\n');
        end
    ...
    methods (Test, TestTags = {'testvector'})
        ...
        %   execution in any other way.
            ...
            import ocuduLib.ran.pusch.ocuduTPMISelect
            ...
            % Select TPMI.
            TpmiInfo = ocuduTPMISelect(H, CodebookSubset, NoiseVar);
