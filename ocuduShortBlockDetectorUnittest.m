%ocuduShortBlockDetectorUnittest Unit tests for the short-block detector.
...
%       testCase = ocuduShortBlockDetectorUnittest
%   and then running all the tests with
%       testResults = testCase.run
%
%   ocuduShortBlockDetectorUnittest Properties (Constant):
%
%   ocuduBlock      - The tested block (i.e., 'short_block_detector').
%   ocuduBlockType  - The type of the tested block, including layer
%                     (i.e., '/phy/upper/channel_coding/short').
%
%   ocuduShortBlockDetectorUnittest Properties (ClassSetupParameter):
%
%   outputPath - Path to the folder where the test results are stored.
%
%   ocuduShortBlockDetectorUnittest Properties (TestParameter):
%
%   msgLength - Length of sequence of decoded bits (1...11).
%   modOrder  - Number of bits per modulation symbol (1, 2, 4, 6, 8).
%
%   ocuduShortBlockDetectorUnittest Methods (TestTags = {'testvector'}):
%
%   testvectorGenerationCases - Generates a test vector for the given message length
%                               and modulation order.
%
%   ocuduShortBlockDetectorUnittest Methods (Access = protected):
%
...
classdef ocuduShortBlockDetectorUnittest < ocuduTest.ocuduBlockUnittest
    properties (Constant)
        %Name of the tested block.
        ocuduBlock = 'short_block_detector'
    ...
    methods (Test, TestTags = {'testvector'})
        ...
        %   and modulation order.
            ...
            modScheme = ocuduGetModulation(modOrder);
            ...
            modScheme = ocuduModulationFromMatlab(modScheme, 'full');
...
end % of classdef ocuduShortBlockDetectorUnittest
