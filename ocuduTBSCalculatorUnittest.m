...
%
%   ocuduTBSCalculatorUnittest Properties (Constant):
%
%   ocuduBlock      - The tested block (i.e., 'tbs_calculator').
%   ocuduBlockType  - The type of the tested block, including layer
%                     (i.e., 'ran/sch').
%
%   ocuduTBSCalculatorUnittest Properties (ClassSetupParameter):
%
%   outputPath - Path to the folder where the test results are stored.
%
%   ocuduTBSCalculatorUnittest Properties (TestParameter):
%
...
%                               parameters.
%
%   ocuduTBSCalculatorUnittest Methods (Access = protected):
%
...
classdef ocuduTBSCalculatorUnittest < ocuduTest.ocuduBlockUnittest
    properties (Constant)
        %Name of the tested block.
        ocuduBlock = 'tbs_calculator'

        %Type of the tested block.
        ocuduBlockType = 'ran/sch'
    end
    ...
    methods (Test, TestTags = {'testvector'})
        ...
        modulation = ocuduGetModulation(modOrder);
